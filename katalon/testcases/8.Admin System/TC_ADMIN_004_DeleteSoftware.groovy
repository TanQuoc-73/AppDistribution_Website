...
try {
    ...
    WebUI.click(findTestObject('Page/Admin/first_software_btn_delete'))
    WebUI.waitForElementVisible(findTestObject('Page/Admin/msg_software_deleted'), 10)
    WebUI.verifyElementPresent(findTestObject('Page/Admin/msg_software_deleted'), 10)
} finally {
    WebUI.closeBrowser()
}
